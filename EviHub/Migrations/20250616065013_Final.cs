...
namespace EviHub.Migrations
{
    ...
    public partial class Final : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certificationprogress_Employees_EmpId",
                        column: x => x.EmpId,
            ...
            migrationBuilder.InsertData(
                table: "Managers",
                columns: new[] { "ManagerId", "Email", "EmpId", "FirstName", "LastName", "Mobile" },
                values: new object[] { 1, "vvsteja23311@gmail.com", 1001, "Sai", "Teja", "89387632" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "IsActive", "ProjectDescription", "ProjectName" },
                values: new object[] { 1, true, "khdcjkdf", "One" });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmpId", "DOB", "DesignationId", "Email", "EmergencyContact", "FirstName", "GenderId", "Id", "Interests", "IsAdmin", "LastName", "ManagerId", "Mobile", "Password", "ProjectId", "Username" },
                values: new object[,]
                {
                    { 1001, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "sai.teja@evihub.com", "9876543211", "Sai", 1, 1, "AI, Cricket", true, "Teja", 1, "9876543210", "jhdc", 1, "kjd" },
                    { 1002, new DateTime(1999, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "anjali.sharma@evihub.com", "9123456790", "Anjali", 1, 2, "Machine Learning, Reading", false, "Sharma", 1, "9123456789", "jhdc", 1, "kjd" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificationprogress_EmpId",
                table: "Certificationprogress",
                column: "EmpId");
